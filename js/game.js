...
//Define Result Element
var result = document.getElementById("result");

//Define Hidder Element

var hidder = document.querySelector(".head-part");

//Define Reset Button 

var reset = document.querySelector("#reset");

//Define Fire Works Element 

var fireWork = document.querySelector("#canvas");
...
//Display The Picked Color In The Page
...
var clickedColor = this.style.backgroundColor;
 ...
 hidder.style.background = clickedColor;
...
// Change The Boxes Color If Right
...
hidder.style.background = '#e84393';

//Change The Picked Color    
pickedColor = randomColor();

//Change Picked Color Display
display.textContent = pickedColor;
    
// Change The Boxs Color
